  ...
  return (
    <div>
      ...
      <ul className="mt-4 border-top border-dark">
                    <li>form checking in table form <i className="bi bi-plus-slash-minus"> : 55%</i></li>
                    <li>combination and decombination of tables  <i className="bi bi-plus-slash-minus"> : 90%</i></li>
